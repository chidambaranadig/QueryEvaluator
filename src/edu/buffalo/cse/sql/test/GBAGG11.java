...
public class GBAGG11 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new GBAGG11());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test GBAGG11");
  }
  public void testSQL() {
    List<List<List<Datum[]>>> expected = new ArrayList<List<List<Datum[]>>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/GBAGG11.SQL"),
                            expected);
    System.out.println("Passed SQL Test GBAGG11");
  }
  ...
  ArrayList<Datum[]> getResultsUD0() {
    ...
    ret.add(new Datum[] {new Datum.Int(2), new Datum.Int(56)}); 
    ret.add(new Datum[] {new Datum.Int(3), new Datum.Int(30)}); 
    ret.add(new Datum[] {new Datum.Int(4), new Datum.Int(42)}); 
    ret.add(new Datum[] {new Datum.Int(5), new Datum.Int(18)}); 
    return ret;
  }
  ArrayList<Datum[]> getResultsFlipGB0() {
    ArrayList<Datum[]> ret = new ArrayList<Datum[]>();
    ret.add(new Datum[] {new Datum.Int(10), new Datum.Int(1)}); 
    ret.add(new Datum[] {new Datum.Int(56), new Datum.Int(2)}); 
    ret.add(new Datum[] {new Datum.Int(30), new Datum.Int(3)}); 
    ret.add(new Datum[] {new Datum.Int(42), new Datum.Int(4)}); 
    ret.add(new Datum[] {new Datum.Int(18), new Datum.Int(5)}); 
    return ret;
  }
}

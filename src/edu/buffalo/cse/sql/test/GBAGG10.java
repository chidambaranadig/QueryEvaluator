...
public class GBAGG10 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new GBAGG10());
  }
  public void testRA() {
    ...
    System.out.println("Passed RA Test GBAGG10");
  }
  public void testSQL() {
    List<List<List<Datum[]>>> expected = new ArrayList<List<List<Datum[]>>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/GBAGG10.SQL"),
                            expected);
    System.out.println("Passed SQL Test GBAGG10");
  }
  ...
  ArrayList<Datum[]> getResultsUD0() {
    ...
    ret.add(new Datum[] {new Datum.Int(1), new Datum.Int(8), new Datum.Flt(4.5)}); 
    ret.add(new Datum[] {new Datum.Int(2), new Datum.Int(23), new Datum.Flt(4.8)}); 
    ret.add(new Datum[] {new Datum.Int(3), new Datum.Int(28), new Datum.Flt(7.5)}); 
    ret.add(new Datum[] {new Datum.Int(4), new Datum.Int(33), new Datum.Flt(5.8)}); 
    ret.add(new Datum[] {new Datum.Int(5), new Datum.Int(26), new Datum.Flt(5.3333335)}); 
    return ret;
  }
  ArrayList<Datum[]> getResultsFlipGB0() {
    ArrayList<Datum[]> ret = new ArrayList<Datum[]>();
    ret.add(new Datum[] {new Datum.Int(8), new Datum.Flt(4.5), new Datum.Int(1)}); 
    ret.add(new Datum[] {new Datum.Int(23), new Datum.Flt(4.8), new Datum.Int(2)}); 
    ret.add(new Datum[] {new Datum.Int(28), new Datum.Flt(7.5), new Datum.Int(3)}); 
    ret.add(new Datum[] {new Datum.Int(33), new Datum.Flt(5.8), new Datum.Int(4)}); 
    ret.add(new Datum[] {new Datum.Int(26), new Datum.Flt(5.3333335), new Datum.Int(5)}); 
    return ret;
  }
}

...
public class GBAGG12 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new GBAGG12());
  }
  public void testRA() {
    ...
    query_0.addAggregate(new AggregateNode.AggColumn("Sum", new ExprTree.VarLeaf(null, "D"),AggregateNode.AType.SUM));
    query_0.setChild(child_1);
    TestHarness.testQuery(tables, getResults0(), query_0);
    System.out.println("Passed RA Test GBAGG12");
  }
  public void testSQL() {
    List<List<List<Datum[]>>> expected = new ArrayList<List<List<Datum[]>>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/GBAGG12.SQL"),
                            expected);
    System.out.println("Passed SQL Test GBAGG12");
  }
  ...
  ArrayList<Datum[]> getResultsUD0() {
    ...
    ret.add(new Datum[] {new Datum.Int(1), new Datum.Int(9)}); 
    ret.add(new Datum[] {new Datum.Int(2), new Datum.Int(25)}); 
    ret.add(new Datum[] {new Datum.Int(3), new Datum.Int(24)}); 
    ret.add(new Datum[] {new Datum.Int(4), new Datum.Int(30)}); 
    ret.add(new Datum[] {new Datum.Int(5), new Datum.Int(11)}); 
    return ret;
  }
  ArrayList<Datum[]> getResultsFlipGB0() {
    ArrayList<Datum[]> ret = new ArrayList<Datum[]>();
    ret.add(new Datum[] {new Datum.Int(9), new Datum.Int(1)}); 
    ret.add(new Datum[] {new Datum.Int(25), new Datum.Int(2)}); 
    ret.add(new Datum[] {new Datum.Int(24), new Datum.Int(3)}); 
    ret.add(new Datum[] {new Datum.Int(30), new Datum.Int(4)}); 
    ret.add(new Datum[] {new Datum.Int(11), new Datum.Int(5)}); 
    return ret;
  }
}

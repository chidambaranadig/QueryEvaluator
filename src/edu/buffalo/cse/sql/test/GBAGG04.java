...
public class GBAGG04 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new GBAGG04());
  }
  public void testRA() {
    ...
    query_0.addAggregate(new AggregateNode.AggColumn("Max", new ExprTree.VarLeaf(null, "B"),AggregateNode.AType.MAX));
    query_0.setChild(child_1);
    TestHarness.testQuery(tables, getResults0(), query_0);
    System.out.println("Passed RA Test GBAGG04");
  }
  public void testSQL() {
    List<List<List<Datum[]>>> expected = new ArrayList<List<List<Datum[]>>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/GBAGG04.SQL"),
                            expected);
    System.out.println("Passed SQL Test GBAGG04");
  }

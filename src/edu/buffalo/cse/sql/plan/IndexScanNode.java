...
public class IndexScanNode extends PlanNode.Leaf {
  ...
  public IndexScanNode(String table, String rangeVariable, Schema.Table schema) 
  { 
    super(PlanNode.Type.ISCAN); 
    this.table = table; 
    this.schema = schema.changeRangeVariable(rangeVariable);
  }
  public IndexScanNode(String table, Schema.Table schema) 
  {
